...
/**
 * Demo job command queue interface
 * @author Michael Lavelle
 */
public interface DemoJobCommandQueue 
    extends PersistentJobCommandQueue<DemoCommandExecutionContext, DemoQueueType, ObjectId> {
