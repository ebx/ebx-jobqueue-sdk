...
/**
 * A JobStatus which indicates that a job is uncompleted but is UNCOMPLETED_WITH_WARNING
 *
 * @author Michael Lavelle
 */
public class JobWarningStatus extends JobStatus {

  /**
   * Instantiates a new Job warning status.
   *
   * @param warning The details of the exception which caused or details the warning
   */
  public JobWarningStatus(Exception warning) {
    super(JobStatusType.UNCOMPLETED_WITH_WARNING, warning);
  }
